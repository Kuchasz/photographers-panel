                    ...
                    <div className="flex flex-col items-center">
                        ...
                        <div className="flex space-x-3 mt-4">
                            <a
                                ...
                                className="flex h-8 w-8 items-center justify-center rounded-full bg-gold-100 text-gold-600 transition duration-200 hover:bg-gold-500 hover:text-white"
                            >
                ...
                <div className="space-y-6">
                    <ul className="space-y-3 font-light">
                        <li className="flex items-start">
                            <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 mt-0.5 mr-3 text-gold-500" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        ...
                        <li className="flex items-start">
                            ...
                            <a href={`tel:${strings.contact.phone}`} className="text-stone-600 hover:text-gold-500 transition duration-200">
