...
export interface Config {
  ...
  collections: {
    ...
    'private-gallery-photo': PrivateGalleryPhoto;
  ...
  collectionsSelect: {
    ...
    'private-gallery-photo': PrivateGalleryPhotoSelect<false> | PrivateGalleryPhotoSelect<true>;
...
/**
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "private-gallery-photo".
 */
export interface PrivateGalleryPhoto {
  id: number;
  alt: string;
  updatedAt: string;
  createdAt: string;
...
export interface PayloadLockedDocument {
  ...
  document?:
    ...
    | ({
        relationTo: 'private-gallery-photo';
        value: number | PrivateGalleryPhoto;
      } | null)
    | ({
...
/**
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "private-gallery-photo_select".
 */
export interface PrivateGalleryPhotoSelect<T extends boolean = true> {
  alt?: T;
  updatedAt?: T;
  createdAt?: T;
  url?: T;
