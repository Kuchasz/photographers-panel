...
type Tariff = { type: TariffPositions; offerAlias?: string, requires: TariffPositions[]; prices: TariffValues };
...
const tariffPositions: Tariff[] = [
    { type: "WeddingPhotography", offerAlias: "fotografia-slubu-i-wesela", requires: [], prices: { 2021: 1800, 2022: 1900, 2023: 1900 } },
    { type: "WeddingVideo", offerAlias: "filmowanie-slubu-i-wesela", requires: [], prices: { 2021: 1800, 2022: 1900, 2023: 1900 } },
    { type: "WeddingSession", offerAlias: "slubna-sesja-zdjeciowa", requires: [], prices: { 2021: 600, 2022: 600, 2023: 600 } },
                        ...
                        <div className="rules">
                            {tariffPositions.map(t => (
                                <div className={`rule ${available(selectedTariffs)(t) ? "" : "disabled"}`} key={t.type}>
                                    ...
                                    {t.offerAlias && <Link to={getOfferUrl(t.offerAlias)}>{`(${strings.offer.readMore}...)`}</Link>}
                                </div>
                            ))}
                        </div>
