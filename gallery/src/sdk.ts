...
export type LikesQuery = { __typename?: 'Query' } & {
    likes: Array<{ __typename?: 'Like' } & Pick<Like, 'imageId' | 'liked' | 'likes'>>;
};
...
export type LikeImageMutation = { __typename?: 'Mutation' } & {
    likeImage: { __typename?: 'Like' } & Pick<Like, 'imageId'>;
};
...
export type UnlikeImageMutation = { __typename?: 'Mutation' } & {
    unlikeImage: { __typename?: 'DeleteResult' } & Pick<DeleteResult, 'affectedRows'>;
};
...
export type ConnectClientMutation = { __typename?: 'Mutation' } & {
    connect: { __typename?: 'Client' } & Pick<Client, 'id'>;
};
