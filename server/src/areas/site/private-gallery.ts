...
export const subscribeForNotification = async (req, res) => {
...
export const getGalleryUrl = async (req, res) => {
    const gallery = await privateGalleryModel.getUrl(req.params.password);

    res.json(gallery);
};

export const postViewGallery = async (req, res) => {
...
export const getViewGallery = async (req, res) => {
