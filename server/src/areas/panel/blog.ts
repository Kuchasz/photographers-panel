...
export const getBlogSelectList = async (req, res) => {
...
export const checkAliasIsUnique = async (req, res) => {
...
export const changeBlogVisibility = async (req, res) => {
...
export const changeMainBlogAsset = async (req, res) => {
...
export const uploadBlogAsset = async (req: Express.Request, res) => {
...
export const getBlogAssets = async (req, res) => {
    const blogAssets = await blogModel.getAssetsForBlog(Number(req.params.blogId));
    res.json(blogAssets);
};

export const deleteBlogAsset = async (req, res) => {
...
export const changeBlogAssetAlt = async (req, res) => {
...
export const getBlogVisits = async (req, res) => {
...
export const getMainBlogs = async (req, res) => {
    const mainBlogs = await blogModel.getMainBlogs();
    res.json(mainBlogs);
};

export const changeMainBlogs = async (req, res) => {
