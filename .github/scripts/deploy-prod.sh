...
if [ -d "public_nodejs/public/uploads" ]; then
  ...
  rm -rf ../backups/uploads_backup_prod
  mkdir -p ../backups/uploads_backup_prod
  cp -r public_nodejs/public/uploads/* ../backups/uploads_backup_prod/
...
if [ -d "../backups/uploads_backup_prod" ]; then
  echo "♻️ Restoring uploads directory..."
  mkdir -p public_nodejs/public/uploads
  cp -r ../backups/uploads_backup_prod/* public_nodejs/public/uploads/
