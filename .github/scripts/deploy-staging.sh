...
if [ -d "public_nodejs/public/uploads" ]; then
  ...
  rm -rf ../backups/uploads_backup_staging
  mkdir -p ../backups/uploads_backup_staging
  cp -r public_nodejs/public/uploads/* ../backups/uploads_backup_staging/
...
if [ -d "../backups/uploads_backup_staging" ]; then
  echo "♻️ Restoring uploads directory..."
  mkdir -p public_nodejs/public/uploads
  cp -r ../backups/uploads_backup_staging/* public_nodejs/public/uploads/
